...
class ModelArgs:
    ...
    ffn_dim_multiplier: Optional[float] = None ######llama2
    distribution: Optional[bool] = None
    norm_eps: float = 1e-5
    hidden_proj: int=128
    n_kv_heads: None # Number of key and value heads.
...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: ModelArgs):
        ...
        self.feed_forward = FeedForward(
            dim=args.dim, hidden_dim=4 * args.dim, multiple_of=args.multiple_of, ffn_dim_multiplier=args.ffn_dim_multiplier, distribution=args.distribution
        )
...
class Transformer(nn.Module):
    def __init__(self, params: ModelArgs):
        ...
        print('⭐️_⭐️_⭐️i⭐️n⭐️i⭐️t⭐️_⭐️_⭐️')
    ...
    def forward(self, examples, labels, images=None, prefix_img=None, prefix_nonimg=None, img_indicators=None):
        ...
        # with autocast():
        image_embeds = self.adapter_proj(image_embeds)    ############################### Here! Here is the adapter!
